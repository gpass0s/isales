...
Last modified on Mon Mar 30 18:47 BRT
...
def test_fetch_from_hubspot(mocked_build_url, mocked_request, mocked_redis_connection_manager):
    ...
    expected_response = {
        "new_contacts": [_SUBSCRIPTION_ITEMS[1]],
        "deal_contacts": [{"associations": {"associatedVids": [383216495]}}]
    }
...
def test_hubspot_fetcher_build_contact_url(mocked_redis_connection_manager):
    ...
    expected_response = "https://api.hubapi.com/contacts/v1/vid=1&vid=2&vid=3&vid=4&vid=5"
